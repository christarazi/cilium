...
func (sc *SelectorCache) AddIdentitySelector(user CachedSelectionUser, selector api.EndpointSelector) (cachedSelector CachedSelector, added bool) {
	...
	// Trigger any asynchronous allocation of any CIDR labels we may be selecting
	// This will cause any endpoints waiting on this to be regenerated twice in
	// quick succession, but will reduce load on the ipcache.
